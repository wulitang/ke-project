(function(root, factory) {
  ...
  Circles = function(options) {
    ...
    this._value          = 0;
    this._maxValue       = options.maxValue || 5;//设置圆圈内的最大数值
...
<!--设置圆圈的颜色-->
var colors = [
  ['#e0e0e0', '#ff6900'], ['#e0e0e0', '#ff6900'], ['#e0e0e0', '#ff6900']
], circles = [];
<!--设置圆圈的颜色-->
for (var i = 1; i <= 3; i++) {
  var child = document.getElementById('circles-' + i);
  <!--获取圆圈的内的值-->
  var circle1=document.getElementById("percent1").innerHTML;
  var circle2=document.getElementById("percent2").innerHTML;
  var circle3=document.getElementById("percent3").innerHTML;
  percentage = [circle1,circle2,circle3] ;
  <!--设置圆圈的样式-->
